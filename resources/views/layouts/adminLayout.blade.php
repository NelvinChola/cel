            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('clients.index') }}">View All</a>
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        {{-- <h6 class="collapse-header">Custom Utilities:</h6> --}}
                        <a class="collapse-item" href="{{ route('products.index') }}">View All</a>
...
<li class="nav-item">
    ...
    <div id="collapseTeam" class="collapse" aria-labelledby="headingTeam" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ route('team-members.index') }}">View All</a>
            <a class="collapse-item" href="{{ route('team-members.create') }}">Add Team Member</a>
        </div>
    </div>
</li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; CEL Admin 2025</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
