    ...
    <section id="about" class="about section">
        ...
        <div class="container">
            <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-5">
                    <img src="{{ asset('assets/img/company1.jpg') }}" class="img-fluid" alt="Cyber Express Ltd Team">
                </div>
            ...
            <div class="why-us-row g-0">
                <div class="why-us-image-col" data-aos="fade-up" data-aos-delay="100">
                    <div class="why-us-image-wrapper">
                        <img src="{{ asset('assets/img/develop.jpg') }}" alt="Cyber Express Development Team">
